    ...
    <div className="freemigration-container">
      <div className="grid-freemigration">
        <div className="freemigration-left">
          ...
          <button className="cards-freemigration-button">Ver todas las soluciones</button>
        </div>
        <div className="freemigration-right">
          <img className="freemigration-img" src="/freemigration.webp" alt="Soluciones de hosting" />
        </div>
      </div>
      <div className="container-freemigration-bottom">
        <div className="cards-freemigration-review">
          <h1 className="h1-freemigration-bottom">
            <FaStar color="#00B090" /> Trustpilot
          </h1>
          <p className="freemigration-p">
